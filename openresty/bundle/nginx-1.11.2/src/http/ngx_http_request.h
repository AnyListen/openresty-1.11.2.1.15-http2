...
struct ngx_http_request_s {
    ...
    //add by wumm 防抖动，限速限量组合时间间隔
	ngx_msec_t			              limit_msec;
    ngx_flag_t						 dnion_request;
	//
    ...
    //add by wumm二次调度标志
    ngx_flag_t		 gslb_dispatch;
    ngx_str_t		 request_id;
    ngx_msec_t               send_response_time;
	ngx_flag_t                        backupos_request;
	ngx_str_t			      redirect302_desip;
	//
