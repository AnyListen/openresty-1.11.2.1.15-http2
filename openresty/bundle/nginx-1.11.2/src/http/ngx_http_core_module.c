...
static ngx_command_t  ngx_http_core_commands[] = {
	...
	///add by zdw
    { ngx_string("limit_rate_interval"),
	NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_HTTP_LIF_CONF
		|NGX_CONF_TAKE1,
	ngx_conf_set_sec_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(ngx_http_core_loc_conf_t, limit_rate_interval),
	NULL },
...
ngx_http_core_create_loc_conf(ngx_conf_t *cf)
{
	...
	//add by zdw
    clcf->limit_rate_interval = NGX_CONF_UNSET_MSEC;
    ////
...
ngx_http_core_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    //add by zdw
    ngx_conf_merge_msec_value(conf->limit_rate_interval, prev->limit_rate_interval, 0);
    // 
